        ...
        <main className="flex-1 md:ml-64 flex flex-col min-h-screen">
          ...
          <div className="flex-grow flex flex-col p-4 md:p-8 gap-10 w-full max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30 flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="text-3xl md:text-4xl font-black text-slate-800">$4,250.00</p>
                </div>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30 flex items-center gap-6">
                ...
                <div>
                  <p className="text-sm text-slate-500 font-bold uppercase tracking-wide">Total Requests</p>
                  <p className="text-3xl md:text-4xl font-black text-slate-800">24</p>
                </div>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30 flex items-center gap-6">
                ...
                <div>
                  <p className="text-sm text-slate-500 font-bold uppercase tracking-wide">Accepted Missions</p>
                  <p className="text-3xl md:text-4xl font-black text-slate-800">18</p>
                </div>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30 flex items-center gap-6">
                <div className="size-16 rounded-2xl bg-red-50 text-red-600 flex items-center justify-center shrink-0">
                  <span className="material-symbols-outlined text-3xl">cancel</span>
                </div>
                <div>
                  <p className="text-sm text-slate-500 font-bold uppercase tracking-wide">Rejected Missions</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-1 bg-white rounded-2xl shadow-sm border border-outline-variant/30 p-5 flex flex-col min-h-[550px]">
                ...
                <div className="flex-1 flex flex-col gap-4 overflow-y-auto pr-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <p className="text-sm font-bold text-slate-800 truncate">Delivery #8493 - Potatoes</p>
                      <p className="text-xs text-slate-500 truncate">Completed on Oct 12</p>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <p className="text-sm font-bold text-slate-800 truncate">Delivery #8492 - Wheat</p>
                      <p className="text-xs text-slate-500 truncate">Completed on Oct 09</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-black text-primary">+$115</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <p className="text-sm font-bold text-slate-800 truncate">Delivery #8490 - Soybeans</p>
                      <p className="text-xs text-slate-500 truncate">Completed on Oct 07</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-black text-primary">+$90</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 overflow-hidden">
                      <p className="text-sm font-bold text-slate-800 truncate">Delivery #8488 - Corn Loads</p>
                      <p className="text-xs text-slate-500 truncate">Completed on Oct 04</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-black text-primary">+$130</p>
                    </div>
                  </div>

                  {/* History Item 5 */}
                  <div className="flex items-center gap-3 opacity-60">
                    <div className="size-10 rounded-full bg-red-50 text-red-500 flex items-center justify-center shrink-0">
                      <span className="material-symbols-outlined text-[20px]">close</span>
                    </div>
                    <div className="flex-1 overflow-hidden">
                      <p className="text-sm font-bold text-slate-800 truncate">Delivery #8491 - Apples</p>
                      <p className="text-xs text-slate-500 truncate">Rejected (Too Far)</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-bold text-slate-400 line-through">+$40</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="lg:col-span-2 bg-white rounded-3xl shadow-md border border-primary/20 overflow-hidden flex flex-col md:flex-row relative cursor-pointer hover:shadow-lg transition-all group min-h-[550px]"
                   onClick={() => navigate('/transporter/missions')}>
                
                {/* Visual "Go to Mission" overlay on hover */}
                ...
                <div className="w-full md:w-5/12 bg-slate-50 flex flex-col">
                  ...
                  <div className="p-6 md:p-8 flex-1 flex flex-col gap-2 justify-center border-r border-outline-variant/30">
                    ...
                    <h3 className="text-2xl font-black text-slate-800 leading-tight">50kg Organic Wheat</h3>
                    ...
                    <div className="mt-4 space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <p className="text-sm font-medium text-slate-800">Green Valley Farm</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <p className="text-sm font-medium text-slate-800">Central Silo</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="p-6 md:p-8 overflow-y-auto flex-1 bg-surface-container-lowest">
              {historyTab === 'accepted' && (
                <div className="space-y-4">
                  {[1, 2].map((i) => (
                    <div key={i} className="flex flex-col sm:flex-row items-center gap-6 p-5 border border-outline-variant/50 rounded-2xl hover:border-primary/50 transition-colors bg-white shadow-sm">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        <h4 className="font-black text-xl text-slate-800">Delivery #{8493 + i} - Potatoes</h4>
                        <p className="text-base text-slate-500 mt-1">Completed on {new Date().toLocaleDateString()}</p>
                      </div>
                      <div className="text-right">
                        <p className="font-black text-primary text-2xl">+$85.00</p>
              ...
              {historyTab === 'rejected' && (
                <div className="space-y-4">
                   <div className="flex flex-col sm:flex-row items-center gap-6 p-5 border border-outline-variant/30 rounded-2xl opacity-75 grayscale-[30%] bg-surface">
                      ...
                      <div className="flex-1 text-center sm:text-left">
                        <h4 className="font-black text-xl text-slate-700">Delivery #8491 - Apples</h4>
                        <p className="text-base text-slate-500 mt-1">Rejected • Too far from current location</p>
                      </div>
                      <div className="text-right">
                        <p className="font-bold text-slate-400 text-xl sm:line-through">$40.00</p>
                      </div>
                    </div>
                </div>
              )}
